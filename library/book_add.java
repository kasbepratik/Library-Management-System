...
public class book_add extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(153, 153, 255)), "New Book", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 24), new java.awt.Color(153, 153, 255))); // NOI18N
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        ...
        String sql_qry = "INSERT INTO book VALUES ('" + isbn + "', '" + name + "', " + edition + ", '" + publisher + "', " + price + ", " + page + ")";
        boolean result = db.execute(sql_qry);
        if (result) {
            Tools.Helper.show(this, "Book is inserted");
            txt_isbn.setText("");
            txt_name.setText("");
            txt_edition.setText("");
