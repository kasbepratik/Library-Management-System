...
public class Member_edit extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(102, 204, 255)), "Edit Member", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 24), new java.awt.Color(255, 153, 153))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String qry = "UPDATE member SET name = '" + name + "', last_name = '" + last_name + "', gender = '" + gender + "', phone_no = '" + phone_no + "' WHERE id = " + member_id;
        boolean r = db.execute(qry);
        if (r) {
            
            this.setVisible(false);
            new Member_list().setVisible(true);
            Tools.Helper.show(this, "Member  updated successfully");
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        cb_gender.setSelectedItem(data[0][3]);
